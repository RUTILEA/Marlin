...
#define DISABLE_INACTIVE_J false
#define DISABLE_INACTIVE_K false
#define DISABLE_INACTIVE_U false
#define DISABLE_INACTIVE_V false
#define DISABLE_INACTIVE_W false
